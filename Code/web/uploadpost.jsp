...
<div id="Credit" class="tabcontent">
  ...
  <%@ include file="connect.jsp" %>
	...
	%>
        <form name="myform" action="airtelact.jsp" method="post" id="" >
         <center>
     ...
     <tr>
         ...
         <td><input type= "radio" name= "courses" value="" required=""/></td>
                    
    <td><font color="black"><%=rs1.getString("plan")%></td>
    <td><font color="black"><textarea rows="4" cols="25" readonly=""><%=rs1.getString("description")%></textarea></td>
...
<div id="Debit" class="tabcontent">
    <br>
    <%
        String sql="select * from plans where community = 'Jio' "; 
	Statement st=connection.createStatement();
	ResultSet rs=st.executeQuery(sql);
	%>
        <form name="myform" action="jioact.jsp" method="post" id="" >
         <center>
    ...
    <td><font color="black"><textarea rows="4" cols="25" readonly=""><%=rs.getString("description")%></textarea></td>
