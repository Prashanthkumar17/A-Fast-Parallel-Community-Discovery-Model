    ...
    PreparedStatement ps1 = connection.prepareStatement("update boundarynodes set totalcount = "+total+",others = "+j+" where community = 'Jio' and username = '"+username+"' ");
    ps1.executeUpdate();
