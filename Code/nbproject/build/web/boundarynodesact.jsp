...
<body>
    ...
    String community = request.getParameter("community");
        ...
        String sql4="select * from boundarynodes where username = '"+username+"' and community = '"+community+"' "; 
	Statement st4=connection.createStatement();
	ResultSet rs4=st4.executeQuery(sql4);
	%>
        
         <center>
        <h2><font color="black" size="5"> Boundary Nodes </font></h2>
    ...
    <td><font color="black"><%=rs4.getString(4)%></td>
      ...
      <BR/><BR/>   
      <a href="boundarynodes.jsp"><button type="button">BACK</button></a>   
      </center>
